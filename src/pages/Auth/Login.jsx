    ...
    <div>
      ...
      <div className="flex flex-col justify-center items-center text-center w-2/3 mx-auto h-screen mt-[-100px]">
        ...
        <div className="space-y-4 w-[350px] mt-12">
          {/* 카카오 로그인 */}
          <button className="w-full h-[52px] bg-[#fee500] text-black font-bold rounded-[12px] flex items-center pl-4 pr-6 relative">
            <img src={kakao} alt="Kakao Logo" className="absolute left-4 h-6" />
            <span className="flex-1 text-center">카카오 로그인</span>
          </button>

          {/* 구글 로그인 */}
          <button className="w-full h-[52px] bg-white text-black font-bold rounded-[12px] flex items-center pl-4 pr-6 relative border border-[#d9d9d9]">
            <img
              src={google}
              alt="Google Logo"
