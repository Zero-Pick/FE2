...
const Toast2 = ({ title, message, onClose }) => {
  useEffect(() => {
      ...
      <div className="bg-white rounded-lg p-6 w-[455px] shadow-lg flex flex-col items-center">
        <div className="mb-2">
          <svg
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_787_6718)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
        ...
        {/* Title */}
        <span className="text-[15px] font-semibold text-[#323232] mb-2 text-center">
          {title}
        </span>

        {/* Message */}
        <span className="text-[14px] font-normal text-[#646464] text-center">
          {message}
        </span>
      </div>
    </div>
