      ...
      <nav className="flex w-[1100px] justify-between items-center">
        ...
        <div>
          <input
            ...
            className="w-[500px] justify-between bg-gray-200 text-black p-2 focus:outline-none"
          />
        </div>
        {/* MyPage */}
        <div className="relative inline-block font-bold">
          ...
          {isDropdownVisible && (
            <div
              id="dropdown"
              className="absolute top-9 right-0 mt-2 w-[320px] bg-[#f1f1f1] shadow-lg rounded-lg p-4 z-10"
            >
