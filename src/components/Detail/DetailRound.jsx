...
const DetailRound = ({ label,  value,  unit , roundColor = "bg-buttongray"}) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className={`flex flex-col items-center justify-center w-[208px] h-[208px]  ${roundColor} rounded-full`}>
